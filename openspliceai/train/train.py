...
def initialize_model_and_optim(device, flanking_size, epochs, scheduler, in_channels=8):
    # Hyper-parameters:
...
def train(args):
    ...
    # Detect input channels from the dataset: 4 = sequence-only (vanilla),
    # 8 = sequence + structure (dot-bracket + wobble -> structure-encoder branch).
